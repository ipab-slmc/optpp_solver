...
def figureEight(t):
    return array([0.6, -0.0 + math.sin(t * 2.0 * math.pi * 0.5) * 0.1, 0.5 + math.sin(t * math.pi * 0.5) * 0.2, 0, 0, 0])

exo.Setup.initRos()
(sol, prob)=exo.Initializers.loadXMLFull('{optpp_solver}/resources/optpp_ik_bounded.xml')
